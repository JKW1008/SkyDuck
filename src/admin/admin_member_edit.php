...
<body>
    ...
    ?>
            ...
            <?php if (!in_array($domain, ['gmail.com', 'naver.com', 'kakao.com', 'hanmail.net'])) : ?>
            <select name="email_domain" id="email_domain">
                <option value="gmail.com">gmail.com</option>
                <option value="naver.com">naver.com</option>
                <option value="kakao.com">kakao.com</option>
                <option value="hanmail.net">hanmail.net</option>
                <option value="manual_input" selected>직접입력</option>
            </select>
            <input type="text" id="manual_email_input" value="<?= $domain ?>" placeholder="이메일을 입력해 주세요">
            <?php else : ?>
            <select name="email_domain" id="email_domain">
