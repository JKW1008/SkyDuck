...
<!-- <div id="inputform">
    ...
    <div id="addressWrap">
        ...
        <div class="w-50">
            ...
            <input type="text" name="member_addr1" id="member_addr1" placeholder="" value="<?= $memArr['Address']; ?>">
        </div>
        <div class="w-50">
            <label for="member_addr2">상세주소</label>
            <input type="text" name="member_addr2" id="member_addr2" placeholder="상세주소를 입력해 주세요" value="<?= $memArr['DetailAddress'] ?>">
        </div>
    </div>
    <div id="buttonwrap">
