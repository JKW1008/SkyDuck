...
<div class="pt-10 m-auto w-4/5 md:w-1/2 max-[1004px]:w-4/5">
    <div id="inputform">
        ...
        <div class="flex max-[369px]:block ">
            ...
            <div class="w-full">
                <div class="flex justify-between gap-1">
                    <input class="rounded-md border-[#D9D9D9] w-4/6 " type="text" name="id" id="member_id">
                    <button class="rounded-md bg-[#182548] w-2/6 text-white font-bold text-base py-2 px-3 " id="btn_member_id_check" type="button">아이디 중복확인</button>
                </div>    
                <p class="text-[#7D7D7D] text-xs">(영문소문자/숫자, 4~16자)</p>
            </div>
        </div>
        <div class="flex mt-4">
            <div class="w-1/5"><label class="flex pt-2" for="member_password">비밀번호 <p class="text-red-600">*</p></label></div>
            <div class="w-full">
        ...
        <div class="flex mt-4">
            <div class="w-1/5"><label class="flex pt-2" for="member_password_check">비밀번호확인 <p class="text-red-600">*</p></label></div>
        ...
        <div class="flex mt-4" >
            ...
            <div class="w-full">
                <div class="flex justify-between items-center gap-4">
                    <input class="w-1/4  rounded-md border-[#D9D9D9]" type="text" id="member_email" name="email" placeholder="이메일을 입력해주세요">@
                    <input class="w-1/4  rounded-md border-[#D9D9D9]" type="text" id="manual_email_input" placeholder="이메일을 입력해 주세요">
                    <select class="w-1/4  rounded-md border-[#D9D9D9]" name="email_domain" id="email_domain">
