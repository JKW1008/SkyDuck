...
<div class="pt-10 m-auto w-4/5 max-[1004px]:w-4/5">
    <div class="flex max-[1100px]:block ">
        <div class="w-1/3 max-[1100px]:w-full ps-2 pb-3"><h2 class=" font-bold"><p>상담에 필요한 기본정보를</p> <p>입력해 주세요</p></h2></div class="w-1/5 max-[369px]:w-full">
        <div class="w-full grid grid-cols-2 gap-1 lg:grid-cols-3 ps-2 pb-3">
            <div class="relative w-full">
                <input class="placeholder-slate-400 rounded-md border-[#D9D9D9] w-full" type="text" id="qna_name" placeholder="이름">
            </div>
            <div class="relative w-full">
                <input class="placeholder-slate-400 rounded-md border-[#D9D9D9] w-full" type="tel" id="qna_tel" placeholder="연락처">
                <div class="absolute inset-y-1 left-0 pl-16 flex items-center pointer-events-none text-red-600">
                    *
                </div>
            </div>
            <div class="relative w-full">
                <input class="placeholder-slate-400 rounded-md border-[#D9D9D9] w-full" type="email" id="qna_email" placeholder="이메일">
                <div class="absolute inset-y-1 left-0 pl-16 flex items-center pointer-events-none text-red-600">
                    *
                </div>
            </div>
            <div class="relative w-full">
                <input class="placeholder-slate-400 rounded-md border-[#D9D9D9] w-full" type="text" id="qna_company_name" placeholder="회사명">
                <div class="absolute inset-y-1 left-0 pl-16 flex items-center pointer-events-none text-red-600">
                    *
                </div>
            </div>
            <div class="w-full"><input class="rounded-md border-[#D9D9D9] placeholder-slate-400 w-full" type="text" id="qna_grade" placeholder="직급"></div>
            <div class="w-full"><input class="rounded-md border-[#D9D9D9] placeholder-slate-400 w-full" type="text" id="qna_user_page" placeholder="홈페이지"></div>
        </div>
    </div>
</div>
...
<div class="pt-10 m-auto w-4/5 max-[1004px]:w-4/5">
    <div class="flex max-[1100px]:block ">
        <div class="w-1/3 max-[1100px]:w-full ps-2 pb-3"><h2 class=" font-bold"><p>어떤 서비스가 필요하신가요?</p> <p>다중선택이 가능합니다.</p></h2></div>
...
<div class="pt-10 m-auto w-4/5 max-[1004px]:w-4/5">
    <div class="flex max-[1100px]:block ">
        <div class="w-1/3 max-[1100px]:w-full ps-2 pb-3" ><h2 class=" font-bold">예산과 일정은 어떻게 되나요</h2></div>
...
<div class="pt-10 m-auto w-4/5 max-[1004px]:w-4/5">
    <div class="flex max-[1100px]:block ">
        <div  class="w-1/3 max-[1100px]:w-full ps-2 pb-3"><h2 class=" font-bold"><p>자세히 알려주시면</p><p> 정확한 견적에 도움이 됩니다</p></h2></div>
        <div  class="w-full flex ps-2 pb-3 space-x-3">
...
<div class="pt-10 m-auto w-4/5 max-[1004px]:w-4/5 text-center"><button class="rounded-md   bg-black text-white font-bold text-xl px-28 py-4" type="button" id="qna_submit">견적 문의</button></div>
