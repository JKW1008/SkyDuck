    ...
    <main class="" style="height: calc(100vh - 257px);">
        ...
        <table class="mt-3 table table-border table-hover ">
            ...
            foreach ($boardArr as $row) {
                ...
                $cnt++;
                // 2023-11-11 11:11:11
                $row['created_at'] = substr($row['created_at'], 0, 16);
        ...
        <div class="flex justify-end"><a class="rounded-md bg-mblack text-white font-bold p-[10px]" href="./quote_input.php">글쓰기</a></div>
