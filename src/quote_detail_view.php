...
<script src="./js/quote_view.js"></script>
...
<form id="contact-form" action="">
    ...
    <div class="pt-10 m-auto w-4/5 max-[1004px]:w-4/5">
        <div class="flex max-[1100px]:block ">
            ...
            <div class="w-full ps-2 pb-3">

                <div class="relative w-full">
                    <input class="placeholder-slate-400 rounded-md border-[#D9D9D9] w-full" type="text" id="quote_title" placeholder="제목" name="quote_title" value="<?= $boardArr['title'] ?>" readonly>
                </div>
            </div>
        </div>
        <div class="flex max-[1100px]:block ">
            ...
            <div class="w-full ps-2 pb-3">
                ...
                <div class="relative w-full">
                    <input class="placeholder-slate-400 rounded-md border-[#D9D9D9] w-full" type="text" id="quote_password" placeholder="비밀번호" name="quote_password" value="<?= $boardArr['password'] ?>" readonly>
                </div>
            </div>
        </div>
        <div class="flex max-[1100px]:block ">
            ...
            <div class="w-full grid grid-cols-2 gap-1 lg:grid-cols-3 ps-2 pb-3">
                ...
                <div class="relative w-full">
                    <input class="placeholder-slate-400 rounded-md border-[#D9D9D9] w-full" type="text" id="qna_name" placeholder="이름" name="user_name" value="<?= $boardArr['name'] ?>" readonly>
                </div>
                <div class="relative w-full">
                    <input class="placeholder-slate-400 rounded-md border-[#D9D9D9] w-full" type="tel" id="qna_tel" placeholder="연락처" name="user_phone" value="<?= $boardArr['contact_number'] ?>" readonly>

                </div>
                <div class="relative w-full">
                    <input class="placeholder-slate-400 rounded-md border-[#D9D9D9] w-full" type="email" id="qna_email" placeholder="이메일" name="user_email" value="<?= $boardArr['email'] ?>" readonly>

                </div>
                <div class="relative w-full">
                    <input class="placeholder-slate-400 rounded-md border-[#D9D9D9] w-full" type="text" id="qna_company_name" placeholder="회사명" name="company_name" value="<?= $boardArr['company_name'] ?>" readonly>

                </div>
                <div class="w-full"><input class="rounded-md border-[#D9D9D9] placeholder-slate-400 w-full" type="text" id="qna_grade" placeholder="직급" name="company_rank" value="<?= $boardArr['position'] ?>" readonly></div>
                <div class="w-full"><input class="rounded-md border-[#D9D9D9] placeholder-slate-400 w-full" type="text" id="qna_user_page" placeholder="홈페이지" name="user_homepage" value="<?= $boardArr['website'] ?>" readonly></div>
            </div>
        </div>
    </div>
    ...
    <div class="pt-10 m-auto w-4/5 max-[1004px]:w-4/5">
        <div class="flex max-[1100px]:block ">
            ...
            <div class="w-full grid grid-cols-2 md:grid-cols-4 sm:grid-cols-3 gap-1 ps-2 pb-3  ">
                <?php
                $service_required = explode(',', $boardArr['service_required']);
        ...
        <div class="flex max-[1100px]:block ">
            ...
            <div class="w-full flex ps-2 pb-3 space-x-3">
                <div class="w-full flex items-center gap-2">
                    ...
                    <input class="rounded-md border-[#D9D9D9] w-full" type="text" id="qna_budget" placeholder="예산을 입력해 주세요" value="<?= $boardArr['budget'] ?>" readonly>
                </div>
                <div class="w-full flex items-center gap-2">
                    <label class="max-[766px]:hidden w-1/6" for="qna_schedule">일정 <span class="text-red-600">*</span></label>
                    <input class="rounded-md border-[#D9D9D9] w-full " type="text" id="qna_schedule" placeholder="일정을 입력해 주세요" value="<?= $boardArr['timeline'] ?>" readonly>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="pt-10 m-auto w-4/5 max-[1004px]:w-4/5">
        ...
        추가설명: ex 종이종류 및 재질/코팅유무/후가공 등
                " readonly><?= $boardArr['additional_notes'] ?></textarea>
            </div>
        </div>
    </div>
