...
<script src="./js/quote_input.js"></script>
        ...
        <div class="flex max-[1100px]:block ">
            ...
            <div class="w-full ps-2 pb-3">
                ...
                <div class="relative w-full">
                    <input class="placeholder-slate-400 rounded-md border-[#D9D9D9] w-full" type="text" id="quote_title" placeholder="제목" name="quote_title" >
                </div>
            </div>
        </div>
        <div class="flex max-[1100px]:block ">
            ...
            <div class="w-full ps-2 pb-3">
                ...
                <div class="relative w-full">
                    <input class="placeholder-slate-400 rounded-md border-[#D9D9D9] w-full" type="text" id="quote_password" placeholder="비밀번호" name="quote_password" >
                </div>
            </div>
        </div>
        <div class="flex max-[1100px]:block ">
